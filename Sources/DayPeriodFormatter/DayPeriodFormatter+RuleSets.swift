...
extension DayPeriodFormatter {
    static let ruleSetsByLanguageCode: [String: DayPeriodRuleSet] = [
        "en": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .morning1: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 21),
            .night1: .range(from: 21, to: 06),
        ],
        "af": [
            .midnight: .at(time: 00),
            .night1: .range(from: 00, to: 05),
            .morning1: .range(from: 05, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 24),
        ],
        "nl": [
            .midnight: .at(time: 00),
            .night1: .range(from: 00, to: 06),
            .morning1: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 24),
        ],
        "gsw": [
            ...
            .night1: .range(from: 00, to: 05),
            .morning1: .range(from: 05, to: 12),
            .afternoon1: .range(from: 12, to: 14),
            .afternoon2: .range(from: 14, to: 18),
            .evening1: .range(from: 18, to: 24),
        ],
        "de": [
            .midnight: .at(time: 00),
            .night1: .range(from: 00, to: 05),
            .morning1: .range(from: 05, to: 10),
            .morning2: .range(from: 10, to: 12),
            .afternoon1: .range(from: 12, to: 13),
            .afternoon2: .range(from: 13, to: 18),
            .evening1: .range(from: 18, to: 24),
        ],
        "da": [
            .midnight: .at(time: 00),
        ...
        "pt": [
            ...
            .night1: .range(from: 00, to: 06),
            .morning1: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 19),
            .evening1: .range(from: 19, to: 24),
        ],
        "gl": [
            .midnight: .at(time: 00),
            .morning1: .range(from: 00, to: 06),
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 13),
            .evening1: .range(from: 13, to: 21),
            .night1: .range(from: 21, to: 24),
        ],
        "es": [
            .noon: .at(time: 12),
            .morning1: .range(from: 00, to: 06),
            .morning2: .range(from: 06, to: 12),
            .evening1: .range(from: 12, to: 20),
            .night1: .range(from: 20, to: 24),
        ],
        "es_CO": [
            .noon: .at(time: 12),
            .morning2: .range(from: 00, to: 12),
            .evening1: .range(from: 12, to: 20),
            .night1: .range(from: 20, to: 24),
        ],
        "ca": [
            ...
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 13),
            .afternoon2: .range(from: 13, to: 19),
            .evening1: .range(from: 19, to: 21),
            .night1: .range(from: 21, to: 24),
        ],
        "it": [
            .midnight: .at(time: 00),
        ...
        "ro": [
            ...
            .morning1: .range(from: 05, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 22),
            .night1: .range(from: 22, to: 05),
        ],
        "fr": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .night1: .range(from: 00, to: 04),
            .morning1: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 24),
        ],
        "ru": [
        ...
        "bg": [
            .midnight: .at(time: 00),
            .morning1: .range(from: 04, to: 11),
            .morning2: .range(from: 11, to: 14),
            .afternoon1: .range(from: 14, to: 18),
            .evening1: .range(from: 18, to: 22),
            .night1: .range(from: 22, to: 04),
        ],
        "mk": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .night1: .range(from: 00, to: 04),
            .morning1: .range(from: 04, to: 10),
            .morning2: .range(from: 10, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 24),
        ],
        ...
        "sl": [
            ...
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 22),
            .night1: .range(from: 22, to: 06),
        ],
        "cs": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .morning1: .range(from: 04, to: 09),
            .morning2: .range(from: 09, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 22),
            .night1: .range(from: 22, to: 04),
        ],
        ...
        "lv": [
            ...
            .morning1: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 23),
            .night1: .range(from: 23, to: 06),
        ],
        "ur": [
            .midnight: .at(time: 00),
            .morning1: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .afternoon2: .range(from: 16, to: 18),
            .evening1: .range(from: 18, to: 20),
            .night1: .range(from: 20, to: 04),
        ],
        "hi": [
            .midnight: .at(time: 00),
            .morning1: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .evening1: .range(from: 16, to: 20),
            .night1: .range(from: 20, to: 04),
        ],
        "bn": [
            .morning1: .range(from: 04, to: 06),
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .afternoon2: .range(from: 16, to: 18),
            .evening1: .range(from: 18, to: 20),
        ...
        "mr": [
            ...
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .evening1: .range(from: 16, to: 18),
            .evening2: .range(from: 18, to: 21),
            .night1: .range(from: 21, to: 04),
        ],
        "ne": [
            .midnight: .at(time: 00),
            ...
            .morning1: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .afternoon2: .range(from: 16, to: 19),
            .evening1: .range(from: 19, to: 22),
            .night1: .range(from: 22, to: 04),
        ],
        "pa": [
            .midnight: .at(time: 00),
            .morning1: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .evening1: .range(from: 16, to: 21),
            .night1: .range(from: 21, to: 04),
        ],
        "si": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .night2: .range(from: 00, to: 01),
            .morning1: .range(from: 01, to: 06),
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 14),
            .evening1: .range(from: 14, to: 18),
            .night1: .range(from: 18, to: 24),
        ],
        "el": [
            .morning1: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 17),
            .evening1: .range(from: 17, to: 20),
            .night1: .range(from: 20, to: 04),
        ],
        "sq": [
            .midnight: .at(time: 00),
        ...
        "fa": [
            .night2: .range(from: 00, to: 01),
            .morning1: .range(from: 01, to: 04),
            .morning2: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 13),
            .afternoon2: .range(from: 13, to: 19),
            .night1: .range(from: 19, to: 24),
        ],
        "ta": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .morning1: .range(from: 03, to: 05),
            .morning2: .range(from: 05, to: 12),
            .afternoon1: .range(from: 12, to: 14),
            .afternoon2: .range(from: 14, to: 16),
            .evening1: .range(from: 16, to: 18),
            .evening2: .range(from: 18, to: 21),
            .night1: .range(from: 21, to: 03),
        ],
        "te": [
            .midnight: .at(time: 00),
            .morning1: .range(from: 06, to: 12),
        ...
        "ml": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .morning1: .range(from: 03, to: 06),
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 14),
            .afternoon2: .range(from: 14, to: 15),
            .evening1: .range(from: 15, to: 18),
            .evening2: .range(from: 18, to: 19),
            .night1: .range(from: 19, to: 03),
        ],
        "kn": [
            .midnight: .at(time: 00),
            .morning1: .range(from: 06, to: 12),
        ...
        "hu": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .night2: .range(from: 04, to: 06),
            .morning1: .range(from: 06, to: 09),
            .morning2: .range(from: 09, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .evening1: .range(from: 18, to: 21),
            .night1: .range(from: 21, to: 04),
        ...
        "zh": [
            .midnight: .at(time: 00),
            .night1: .range(from: 00, to: 05),
            .morning1: .range(from: 05, to: 08),
            .morning2: .range(from: 08, to: 12),
            .afternoon1: .range(from: 12, to: 13),
            .afternoon2: .range(from: 13, to: 19),
            .evening1: .range(from: 19, to: 24),
        ],
        ...
        "ja": [
            ...
            .morning1: .range(from: 04, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .evening1: .range(from: 16, to: 19),
            .night1: .range(from: 19, to: 23),
            .night2: .range(from: 23, to: 04),
        ],
        "ko": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
        ...
        "th": [
            ...
            .morning1: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 13),
            .afternoon2: .range(from: 13, to: 16),
            .evening1: .range(from: 16, to: 18),
            .evening2: .range(from: 18, to: 21),
            .night1: .range(from: 21, to: 06),
        ],
        "lo": [
            ...
            .afternoon1: .range(from: 12, to: 16),
            .evening1: .range(from: 16, to: 20),
            .night1: .range(from: 20, to: 05),
        ],
        "id": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .morning1: .range(from: 00, to: 10),
            .afternoon1: .range(from: 10, to: 15),
            .evening1: .range(from: 15, to: 18),
            .night1: .range(from: 18, to: 24),
        ],
        "ms": [
            .morning1: .range(from: 00, to: 01),
            .morning2: .range(from: 01, to: 12),
            .afternoon1: .range(from: 12, to: 14),
            .evening1: .range(from: 14, to: 19),
            .night1: .range(from: 19, to: 24),
        ],
        "fil": [
            .midnight: .at(time: 00),
        ...
        "tr": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .morning1: .range(from: 06, to: 11),
            .morning2: .range(from: 11, to: 12),
            .afternoon1: .range(from: 12, to: 18),
            .afternoon2: .range(from: 18, to: 19),
            .evening1: .range(from: 19, to: 21),
            .night1: .range(from: 21, to: 06),
        ],
        "az": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .night2: .range(from: 00, to: 04),
            .morning1: .range(from: 04, to: 06),
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 17),
            .evening1: .range(from: 17, to: 19),
            .night1: .range(from: 19, to: 24),
        ],
        "kk": [
            .midnight: .at(time: 00),
        ...
        "uz": [
            ...
            .noon: .at(time: 12),
            .morning1: .range(from: 06, to: 11),
            .afternoon1: .range(from: 11, to: 18),
            .evening1: .range(from: 18, to: 22),
            .night1: .range(from: 22, to: 06),
        ],
        "ar": [
            .night1: .range(from: 00, to: 01),
            .night2: .range(from: 01, to: 03),
            .morning1: .range(from: 03, to: 06),
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 13),
            .afternoon2: .range(from: 13, to: 18),
        ...
        "he": [
            .midnight: .at(time: 00),
            .night2: .range(from: 03, to: 06),
            .morning1: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .afternoon2: .range(from: 16, to: 18),
            .evening1: .range(from: 18, to: 22),
            .night1: .range(from: 22, to: 03),
        ],
        "am": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
        ...
        "sw": [
            .midnight: .at(time: 00),
            .noon: .at(time: 12),
            .morning1: .range(from: 04, to: 07),
            .morning2: .range(from: 07, to: 12),
            .afternoon1: .range(from: 12, to: 16),
            .evening1: .range(from: 16, to: 19),
            .night1: .range(from: 19, to: 04),
        ],
        "zu": [
            .morning1: .range(from: 00, to: 06),
            .morning2: .range(from: 06, to: 10),
            .afternoon1: .range(from: 10, to: 13),
            .evening1: .range(from: 13, to: 19),
            .night1: .range(from: 19, to: 24),
        ],
        "ka": [
            .midnight: .at(time: 00),
        ...
        "eu": [
            ...
            .morning2: .range(from: 06, to: 12),
            .afternoon1: .range(from: 12, to: 14),
            .afternoon2: .range(from: 14, to: 19),
            .evening1: .range(from: 19, to: 21),
            .night1: .range(from: 21, to: 24),
        ],
        "mn": [
        ...
        "chr": [
            .noon: .at(time: 12),
            .morning1: .range(from: 00, to: 12),
            .afternoon1: .range(from: 12, to: 24),
        ],
        "ee": [
            .morning1: .range(from: 04, to: 05),
            .morning2: .range(from: 05, to: 12),
            .afternoon1: .range(from: 12, to: 14),
            .afternoon2: .range(from: 14, to: 18),
            .evening1: .range(from: 18, to: 21),
